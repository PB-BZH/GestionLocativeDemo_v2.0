...
namespace GestionLocativeDemo.Migrations
{
    ...
    [Migration("20260821160529_AddBailleur")]
    partial class AddBailleur
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionLocativeDemo.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GestionLocativeDemo.Models.Bail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DepotGarantie")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("GestionLocativeDemo.Models.Bailleur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionLocativeDemo.Models.Bien", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionLocativeDemo.Models.Echeance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RentDues", (string)null);
                });

            modelBuilder.Entity("GestionLocativeDemo.Models.Locataire", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionLocativeDemo.Models.Paiement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionLocativeDemo.Models.Bail", b =>
                {
                    ...
                    b.HasOne("GestionLocativeDemo.Models.Locataire", "Locataire")
                        .WithMany()
            ...
            modelBuilder.Entity("GestionLocativeDemo.Models.Echeance", b =>
                {
                    b.HasOne("GestionLocativeDemo.Models.Bail", "Bail")
                        .WithMany()
            ...
            modelBuilder.Entity("GestionLocativeDemo.Models.Paiement", b =>
                {
                    b.HasOne("GestionLocativeDemo.Models.Echeance", "Echeance")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GestionLocativeDemo.Data.ApplicationUser", null)
                        .WithMany()
